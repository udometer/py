...
def plot(loc, z, th, p, qv, u, v, output, time = None, title = None):
  ...
  """
  fig = plt.figure(1, figsize=(19.2, 10.8), edgecolor='k')
...
def plot_legend(axes):
  ...
  plt.legend((lT, lTve, lTd, lTwb, lPT, lTvp,),(tT, tTve, tTd, tTwb, tPT, tTvp,),
             loc=(0.125,0), fontsize=6 * fontscalefactor, handlelength=10)
...
def plot_datablock(ax4, _x,_z,_t,_th,_p,_qv,_u,_v, _title):
  ...
  ax4.set_axis_off()
  plt.axis([-1,1,-1,1])
  plt.text(0,1,_title, verticalalignment='top', horizontalalignment='center', weight='bold', fontsize=10 * fontscalefactor)
  line = ""
  if (_x != None):
  ...
  plt.text(0,.85, line, verticalalignment='center', horizontalalignment='center', fontsize=5 * fontscalefactor)
  ...
  plt.text(-1,.75, line, verticalalignment='center', horizontalalignment='left', fontsize=5 * fontscalefactor)
  ...
  y = 0
  line = 'Hodograph'
  plt.text(x,y, line, verticalalignment='center', horizontalalignment='left', fontsize=5 * fontscalefactor)
  x += 0.02
  y -= 0.065
...
def print_3col(name, value, unit, x, y):
   plt.text(x,y, name, verticalalignment='center', horizontalalignment='left', fontsize=5 * fontscalefactor)
   plt.text(x+.35,y, value, verticalalignment='center', horizontalalignment='right', fontsize=5 * fontscalefactor)
   plt.text(x+.4,y, unit, verticalalignment='center', horizontalalignment='left', fontsize=5 * fontscalefactor)

def print_parcel_info(title, pcl, x, y):
  plt.text(x,y, title, verticalalignment='center', horizontalalignment='left', fontsize=5 * fontscalefactor)
  y -= 0.065
  x += 0.02
...
def label_h(x, y, s, c, r, axes):
	axes.text(x,y,s, verticalalignment='center', horizontalalignment='center', weight='normal', fontsize=6*fontscalefactor, color=c, rotation=r)

def label_h2(x, y, s, c, r, axes):
	axes.text(x,y,s, verticalalignment='center', horizontalalignment='center', weight='bold', fontsize=7*fontscalefactor, color=c, rotation=r)
...
def draw_hodograph(axes, bounds):
  ...
  #for v in np.arange(ymin+1,ymax, 5):
  for v in np.arange(5, ymax+1, 5):
    if (v%5==0) and (v != 0):
